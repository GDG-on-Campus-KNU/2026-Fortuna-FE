...
const getLocalAudioUri = (module: any) => {
  try {
    ...
    console.warn('[MockContents] Failed to resolve asset source', err);
    return '';
  }
};
...
export const mockContents: Content[] = [
  {
    ...
    get audioUrl() {
      return getLocalAudioUri(require('../../../../assets/audios/Sample-1.wav'));
    },
    status: 'done',
  ...
  },
  {
    ...
    get audioUrl() {
      return getLocalAudioUri(require('../../../../assets/audios/Sample-2.wav'));
    },
    status: 'done',
  ...
  },
  {
    ...
    get audioUrl() {
      return getLocalAudioUri(require('../../../../assets/audios/Sample-3.wav'));
    },
    status: 'done',
  ...
  },
  {
    ...
    get audioUrl() {
      return getLocalAudioUri(require('../../../../assets/audios/Sample-4.wav'));
    },
    status: 'done',
